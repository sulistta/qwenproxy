...
[![CI](https://github.com/sulistta/qwenproxy/actions/workflows/ci.yml/badge.svg)](https://github.com/sulistta/qwenproxy/actions/workflows/ci.yml)
...
> ✅ Pronto! Agora use com qualquer cliente OpenAI-compatible apontando para `http://localhost:3000/v1`
...
```bash
git clone https://github.com/sulistta/qwenproxy.git
cd qwenproxy
npm install
